...
class TestOrderStatusGetView:
    base_url = "orders:get_order_status"

    def test_url(self):
        order_id = uuid.uuid4()
        expected_url = f"/api/orders/get-order-status/{order_id}"
    ...
    def test_returns_404_if_task_does_not_exist(self, client):
